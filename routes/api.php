...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('/courses/{courseId}/lessons', [LessonController::class, 'index']);//عرض كل الدروس
    Route::get('/lessons/{id}', [LessonController::class, 'show']);//عرض درس معين
    Route::get('/courses', [CourseController::class, 'index'])->name("AllCourses");//عرض كل الكورسات
    Route::get('/courses/{id}', [CourseController::class, 'show'])->name("Courses");//عرض كورس معين
